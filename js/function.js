	...
	if (array.length > 0) {
		...
		switch (patt1.exec(selector)[0]) {				
			case '01':
				...
				$('#page01').delay(1000).animate({ opacity : 1 , top : 55 }, 400, 'easeInOutExpo');	
			...
			case '02':
				...
				$('#page02').delay(1000).animate({ opacity : 1 , top : 55 }, 400, 'easeInOutExpo');						
			...
			case '03':
				...
				$('#page03').delay(1000).animate({ opacity : 1 , top : 55 }, 400, 'easeInOutExpo');					
			...
			case '04':
				...
				$('#page04').delay(1000).animate({ opacity : 1 , top : 55 }, 400, 'easeInOutExpo');					
			...
			case '05':
				...
				$('#page05').delay(1000).animate({ opacity : 1 , top : 55 }, 400, 'easeInOutExpo');					
			...
			case '06':
				...
				$('#page06').delay(1000).animate({ opacity : 1 , top : 55 }, 400, 'easeInOutExpo');					
			...
			case '07':
				...
				$('#page07').delay(1000).animate({ opacity : 1 , top : 55 }, 400, 'easeInOutExpo');					
